...
<main>
    ...
    <section class=" leading-[1.2]">
        <!-- Delivery System -->
        <div class="pt-20 bg-[#F8F5F1] rounded-4xl overflow-hidden text-center">
            <p class="text-xl font-medium text-[var(--main-brown01)]">디알코디 직영 전문 엔지니어팀의 배송 서비스</p>
            <p class="mt-2 text-[48px] font-bold text-[var(--main-brown02)]">Delivery System</p>
            <div class="grid grid-cols-3 max-md:grid-cols-1 items-center gap-12">
                <!-- CARD -->
                <div>
                    <img src="<?php echo G5_THEME_URL?>/img/detail/delivery-icon-1.svg" alt="">
                    <p class="text-[26px] text-[var(--main-brown03)] font-bold">무료 배송&설치</p>
                    <p class="mt-2 text-xl text-[var(--main-brown03)]">제주도 제외 전국 <br/>어디든 전문 기사 방문</p>
                </div>
        ...
        <div>
            ...
            <div class="py-20 max-md:py-12 bg-[var(--main-brown03)] text-white text-center flex flex-col items-center">
                <img class="max-md:w-[100px]" src="<?php echo G5_THEME_URL?>/img/detail/icon-1.svg" alt="">
                <p class="mt-3 text-[48px] max-md:text-[24px] font-bold bg-gradient-to-b from-[#ECCA75] to-[#634424] bg-clip-text text-transparent">누적 설치 30,000+, 만족도 99.8%</p>
                <p class="text-[48px] max-md:text-[24px] font-bold">자신 있는 후불 결제 서비스</p>
                <p class="mt-7 text-[30px] max-md:text-[15px] max-md:mt-4">설치 후 직접 확인해보고 결제하는 후불 결제 서비스 <br/><span class="underline">만족스럽지 못하시다면 100% 환불해드립니다.</span></p>
                <p class="mt-4 text-[20px] max-md:text-[10px] text-gray-600">단, 계약금은 환불되지 않습니다.</p>
                <!-- CONTAINER -->
                <div class="mt-9 w-full grid grid-cols-3 max-md:grid-cols-1 gap-2">
                    <!-- CARD -->
                    <div class="p-8 max-md:p-3 bg-[#141414] rounded-lg flex flex-col items-center">
                        <img class="w-[40%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-2.svg" alt="">
                        <p class="mt-6 max-md:mt-4 H4 font-semibold text-[var(--main-yellow)] max-md:text-[12px]">계약금만 입금</p>
                        <p class="mt-4 max-md:mt-2 text-[20px] max-md:text-[10px] font-medium">견적 확정 후 <br/>계약금 10만원만 입금</p>
                        <p class="text-base text-gray-500 max-md:text-[8px]">(현금영수증 발행 가능)</p>
                    </div>
                    <!-- CARD -->
                    <div class="p-8 max-md:p-3 bg-[#141414] rounded-lg flex flex-col items-center relative before:content-[''] before:absolute before:left-[-20px] before:top-1/2 before:-translate-y-1/2 before:w-[30px] before:h-[30px] before:bg-[url('<?php echo G5_THEME_URL?>/img/detail/yellow-arrow.svg')] before:bg-contain before:bg-no-repeat before:bg-center">
                        <img class="w-[40%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-3.svg" alt="">
                        <p class="mt-6 max-md:mt-4 H4 font-semibold text-[var(--main-yellow)] max-md:text-[12px]">시공 후 확인</p>
                        <p class="mt-4 max-md:mt-2 text-[20px] max-md:text-[10px] font-medium">설치가 끝나면 직접 눈으로 확인하고 손으로 만져보세요.</p>
                    </div>
                    <!-- CARD -->
                    <div class="p-8 max-md:p-3 bg-[#141414] rounded-lg flex flex-col items-center relative before:content-[''] before:absolute before:left-[-20px] before:top-1/2 before:-translate-y-1/2 before:w-[30px] before:h-[30px] before:bg-[url('<?php echo G5_THEME_URL?>/img/detail/yellow-arrow.svg')] before:bg-contain before:bg-no-repeat before:bg-center">
                        <img class="w-[40%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-4.svg" alt="">
                        <p class="mt-6 max-md:mt-4 H4 font-semibold text-[var(--main-yellow)] max-md:text-[12px]">잔금 결제</p>
                        <p class="mt-4 max-md:mt-2 text-[20px] max-md:text-[10px] font-medium">현장에서 카드 결제 및 계좌이체 가능</p>
                        <p class="text-base text-gray-500 max-md:text-[8px]">(현금영수증 발행 가능)</p>
                    </div>
                </div>
            </div>
            <div class="py-20 max-md:py-16 bg-[#F7F2EE] flex flex-col items-center">
                ...
                <div class="mt-14 max-md:mt-6 grid grid-cols-3 max-md:grid-cols-2">
                    <!-- CARD -->
                    <div class="p-12 max-md:p-4">
                        <img class="m-auto max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-5.svg" alt="">
                        <p class="mt-6 max-md:mt-2 text-[25px] max-md:text-[13px] font-semibold text-[var(--main-brown03)] text-center">폭 넓은 높이 조절의<br/><span class="text-[var(--main-brown01)]">무타공 기둥</span></p>
                    </div>
                    <!-- CARD -->
                    <div class="p-12 max-md:p-4">
                        <img class="m-auto max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-6.svg" alt="">
                        <p class="mt-6 max-md:mt-2 text-[25px] max-md:text-[13px] font-semibold text-[var(--main-brown03)] text-center">최고급 자재 사용<br/><span class="text-[var(--main-brown01)]">국내 본사 제작</span></p>
                    </div>
                    <!-- CARD -->
                    <div class="p-12 max-md:p-4">
                        <img class="m-auto max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-7.svg" alt="">
                        <p class="mt-6 max-md:mt-2 text-[25px] max-md:text-[13px] font-semibold text-[var(--main-brown03)] text-center">E0 등급<br/><span class="text-[var(--main-brown01)]">친환경 자재 사용</span></p>
                    </div>
                    <!-- CARD -->
                    <div class="p-12 max-md:p-4">
                        <img class="m-auto max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-8.svg" alt="">
                        <p class="mt-6 max-md:mt-2 text-[25px] max-md:text-[13px] font-semibold text-[var(--main-brown03)] text-center">무료 배송 및<br/><span class="text-[var(--main-brown01)]">무료 설치 서비스</span></p>
                    </div>
                    <!-- CARD -->
                    <div class="p-12 max-md:p-4">
                        <img class="m-auto max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-9.svg" alt="">
                        <p class="mt-6 max-md:mt-2 text-[25px] max-md:text-[13px] font-semibold text-[var(--main-brown03)] text-center">믿음직한<br/><span class="text-[var(--main-brown01)]">10년 무상 A/S</span>서비스</p>
                    </div>
                    <!-- CARD -->
                    <div class="p-12 max-md:p-4">
                        <img class="m-auto max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/icon-10.svg" alt="">
                        <p class="mt-6 max-md:mt-2 text-[25px] max-md:text-[13px] font-semibold text-[var(--main-brown03)] text-center">자신있는<br/><span class="text-[var(--main-brown01)]">후불 결제</span>서비스</p>
                    </div>
                </div>
            </div>
            <div class="py-16 max-md:p-12 flex flex-col items-center">
            ...
            <div class="p-16 max-md:p-4 flex flex-col items-center">
            ...
            <div class="p-16 max-md:p-12 flex flex-col items-center">
            ...
            <div class="py-20 max-md:py-12 flex flex-col items-center bg-[#F7F2EE] rounded-[80px_80px_0_0] max-md:rounded-[30px_30px_0_0]">
                ...
                <div class="mt-12 flex flex-col gap-16">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="mt-8 max-md:mt-5 grid grid-cols-2 items-center gap-5 max-md:gap-3">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <p class="mt-8 max-md:mt-4 text-[25px] max-md:text-[13px] text-center text-[var(--main-brown02)]"><span class="underline">전문 설치팀이 정성스럽고 완벽하게 설치해드립니다.</span> <br/>디알코디가 드리는 특별한 서비스입니다.</p>
                    </div>
                </div>
            </div>
            <!-- POINT 4 -->
            <div class="pt-20 max-md:pt-8 bg-[url(<?php echo G5_THEME_URL?>/img/detail/img-10.webp)] text-white aspect-[1/1.1] flex flex-col items-center bg-cover">
                ...
                <p class="mt-8 max-md:mt-5 text-[25px] max-md:text-[13px] font-medium text-center">선반, 서랍, 행거 등 20여가지의 모듈을 자유롭게 조합하여 <br/>세상에 단 하나뿐인 당신만의 공간을 만들어보세요.</p>
            </div>
            <!-- POINT 5 -->
            ...
            <div class="py-16 flex flex-col gap-6 text-center items-center bg-[url(<?php echo G5_THEME_URL?>/img/detail/img-14.webp)] bg-cover bg-center">
                <p class="H3 font-bold leading-[1.5] text-white">일상의 품격을 높이는 디알코디, <br/>지금 맞춤 견적을 받아보세요</p>
                <div class="flex gap-3">
                    <a href="#" class="btn bg-white rounded-full p-2 pr-4 flex items-center gap-1.5 border border-gray-200">
                        ...
                        <span class="text-base max-md:text-sm font-semibold text-black">무료 견적 상담 시작하기</span>
                        <img src="<?php echo G5_THEME_URL?>/img/btn-arrow-right.png">
                    </a>
                    <a href="#" class="btn bg-white rounded-full p-2 pr-4 flex items-center gap-1.5 border border-gray-200">
                        <img src="<?php echo G5_THEME_URL?>/img/btn-talk-icon.png">
                        <span class="text-base max-md:text-sm font-semibold text-black">카카오톡 견적 문의</span>
                        <img src="<?php echo G5_THEME_URL?>/img/btn-arrow-right.png">
                    </a>
                </div>
            </div>
            ...
            <!-- 디알코드의 다양한 추가 모듈 -->
            <div class="pt-20 pb-10 flex flex-col items-center bg-[#F7F2EE] rounded-[80px_80px_0_0] max-md:rounded-[30px_30px_0_0]">
                <p class="text-[22px] max-md:text-[12px] font-medium text-[var(--main-brown01)]">모듈을 추가하여 나만의 드레스룸을 완성하세요!</p>
                <p class="mt-3 text-[44px] max-md:text-[22px] font-bold">디알코드의 다양한 추가 모듈</p>
                <!-- CONTAINER -->
                <div class="mt-8 flex flex-col gap-8 max-md:text-center max-md:gap-3">
                    <!-- BOX -->
                    <div class="px-12 py-4 bg-white flex max-md:flex-col justify-between items-center">
                        <div class="flex flex-col gap-3">
                            <p class="text-[34px] max-md:text-[18px] font-bold text-[var(--main-brown02)]">2/3/4단 서랍장</p>
                            <p class="text-[25px] max-md:text-[13px] text-gray-800">넓고 깊게 만들어 <br/>수납률을 높혔습니다.</p>
                        </div>
                        <img class="max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/img-17.webp" alt="">
                    </div>
                    <!-- BOX -->
                    <div class="px-12 py-4 bg-white flex max-md:flex-col justify-between items-center">
                        <div class="flex flex-col gap-3">
                        ...
                        <img class="max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/img-18.webp" alt="">
                    </div>
                    <!-- BOX -->
                    <div class="px-12 py-4 bg-white flex max-md:flex-col justify-between items-center">
                        <div class="flex flex-col gap-3">
                        ...
                        <img class="max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/img-19.webp" alt="">
                    </div>
                    <!-- BOX -->
                    <div class="px-12 py-4 bg-white flex max-md:flex-col justify-between items-center">
                        <div class="flex flex-col gap-3">
                        ...
                        <img class="max-md:w-[50%]" src="<?php echo G5_THEME_URL?>/img/detail/img-20.webp" alt="">
                    </div>
                </div>
            </div>
            <!-- 견적 문의 가이드 -->
            <div class="py-18 flex flex-col items-center bg-[#F7F2EE]">
                ...
                <!-- CONTAINER -->
                <div class="mt-8 max-md:mt-4 grid grid-cols-2 -gap-4 items-center">
                    <!-- BOX -->
                    <div class="px-12 py-6 max-md:p-4 flex flex-col items-center justify-between bg-white">
                ...
                <a href="#" class="mt-8 max-md:mt-4 btn bg-white rounded-full p-2 pr-4 flex items-center gap-1.5 border border-gray-200">
                    <img src="<?php echo G5_THEME_URL?>/img/btn-talk-icon.png">
            ...
            <div class="py-16 bg-[url(<?php echo G5_THEME_URL?>/img/detail/img-24.webp)] flex flex-col items-center bg-cover">
                <p class="H3 font-bold text-[var(--main-brown03)] text-center">카카오톡을 통한 <br class="md:hidden">실시간 견적을 받아보세요.</p>
            ...
            <!-- 간편 사이즈 측정법 -->
            <div class="py-20 max-md:py-12 flex flex-col items-center">
                <p class="text-[22px] max-md:text-[11px] font-medium text-[var(--main-brown01)]">빠르고 쉬운 디알코디의 간편 견적문의</p>
                <p class="mt-3 text-[48px] max-md:text-[24px] font-bold">간편 사이즈 측정법</p>
                <div class="mt-8 grid grid-cols-2 max-md:grid-cols-1 gap-5">
                    <div class="flex flex-col items-center gap-4 max-md:gap-0">
                        <img class="max-md:order-1 max-md:-mt-4 max-md:rounded-lg" src="<?php echo G5_THEME_URL?>/img/detail/img-25.webp" alt="바닥 재는법">
                        <span class="py-2 px-3 text-[24px] max-md:text-[12px] z-10 font-bold bg-[var(--main-brown01)] text-white rounded-full">바닥 재는법</span>
                    </div>
                    <div class="flex flex-col items-center gap-4 max-md:gap-0">
                        <img class="max-md:order-1 max-md:-mt-4 max-md:rounded-lg" src="<?php echo G5_THEME_URL?>/img/detail/img-26.webp" alt="천장 재는법">
                        <span class="py-2 px-3 text-[24px] max-md:text-[12px] z-10 font-bold bg-[var(--main-brown01)] text-white rounded-full">천장 재는법</span>
                    </div>
                </div>
            </div>
            <!-- 주문 전 유의사항 -->
