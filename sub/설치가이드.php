...
<main>
    ...
    <section class="py-20 flex flex-col items-center">
        ...
        <div class="mt-8 p-5 H4 font-semibold rounded-full border border-gray-300"><img class="inline mr-2 mb-1" src="<?php echo G5_THEME_URL?>/img/check.svg"></img>디알코디는 <span class="text-[var(--main-brown01)]">전국 무료 설치</span>가 원칙입니다. (제주도 제외)</div>
        <p class="mt-4 H6 font-medium text-center">다만, 전문가의 손길이 닿기 어려운 제주도 고객님도<br/>완벽한 드레스룸을 경험하실 수 있도록, 100% 성공률의 '셀프 설치 가이드'를 준비했습니다. <br/>영상을 보며 차근차근 따라 하면,<br/>전문가가 없이도 어느새 당신의 공간에 완벽한 드레스룸이 완성될 거예요.</p>
        <video></video>
    </section>
    ...
    <section class="py-20 container flex flex-col items-center">
        ...
        <div class="mt-8 flex flex-col gap-8">
            ...
            <div class="flex max-md:flex-col items-center gap-10 max-md:gap-4">
                ...
                <div class="mt-4 p-4 w-full bg-[#FFF4F4] rounded-sm">
                    <span class="text-base font-bold px-2 py-1 bg-[#A5836A]/10 text-[#E63627]">⚠ 주의</span>
                    <p class="text-base mt-2">※ 방향이 바뀌면 나중에 다시 해야 해요!</p>
                </div>
                </div>
            </div>
            <!-- CARD -->
        ...
        <div class="mt-20 p-12 w-full border border-gray-200 rounded-lg flex max-md:flex-col">
            ...
            <div class="flex flex-col gap-3">
                <h3 class="H4 font-bold"><span class="mr-2 H6 text-white bg-black rounded-md p-2">2과정 핵심 영상</span>기둥에 날개(받침대) 조립하기</h3>
    ...
    <section class="py-20 container flex flex-col items-center">
        ...
        <div class="mt-8 flex flex-col gap-8">
            ...
            <div class="flex max-md:flex-col items-center gap-10 max-md:gap-4">
                ...
                <div class="mt-4 p-4 w-full bg-[#FFF4F4] rounded-sm">
                    <span class="text-base font-bold px-2 py-1 bg-[#A5836A]/10 text-[#E63627]">⚠ 주의</span>
                    <p class="text-base mt-2">기둥을 24cm 띄워서 설치하면 선반은 벽에서 5cm 정도 띄워서 설치되게 됩니다.</p>
                </div>
                </div>
            </div>
            <!-- CARD -->
    ...
    <section class="py-20 bg-gray-50">
        ...
        <h3 class="mt-2 H5 font-semibold">아래 항목들을 모두 확인하면 설치가 완료됩니다.</h3>
            <!-- CONTAINER -->
            <div class="mt-8 grid grid-cols-3 gap-3 max-md:grid-cols-1">
                <!-- CARD -->
                <div class="px-4 py-12 max-md:p-5 border border-gray-300 rounded-md text-center flex flex-col gap-4 justify-center items-center">
                        <img class="" src="<?php echo G5_THEME_URL?>/img/check-2.svg">
                        <h5 class="H5 font-bold">기둥이 천장에 <br/>단단히 고정되었나요?</h5>
                        <h6 class="text-lg font-medium text-[var(--main-brown02)] max-md:mt-1">손으로 흔들어봐도 움직이지 않아야 합니다</h6>
                </div>
                <!-- CARD -->
                <div class="px-4 py-12 max-md:p-5 border border-gray-300 rounded-md text-center flex flex-col gap-4 justify-center items-center">
                        <img class="" src="<?php echo G5_THEME_URL?>/img/check-2.svg">
                        <h5 class="H5 font-bold">모든 선반이 수평인가요?</h5>
                        <h6 class="text-lg font-medium text-[var(--main-brown02)] max-md:mt-1">수평계로 확인하거나 물건을 올려봤을 때 굴러가지 않아야 합니다</h6>
                </div>
                <!-- CARD -->
                <div class="px-4 py-12 max-md:p-5 border border-gray-300 rounded-md text-center flex flex-col gap-4 justify-center items-center">
                        <img class="" src="<?php echo G5_THEME_URL?>/img/check-2.svg">
                        <h5 class="H5 font-bold">전체 구조가 안정적인가요?</h5>
                        <h6 class="text-lg font-medium text-[var(--main-brown02)] max-md:mt-1">옷을 걸어봤을 때<br/>흔들림이 없어야 합니다</h6>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 container flex flex-col items-center">
        <div class="text-center">
            <img src="" alt="">
            <p class="SectionTitleText font-bold">혹시 이런 문제가 있나요?</p>
