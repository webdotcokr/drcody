...
<main>
    ...
    <section class="py-16 container">
        ...
        <p class="text-base font-medium">총 <span class="text-[var(--main-brown01)]">13</span>개의 글</p>
        <table class="mt-4 w-full H6 border-y border-black">
            ...
            <tr class="h-16">
                <td class="w-[10%] text-center text-gray-600">No.</td>
                <td class="w-[70%] font-semibold">제목</td>
                <td class="w-[10%] text-center text-gray-600">등록일</td>
                <td class="w-[10%] text-center text-gray-600">조회</td>
            </tr>
        </table>
    </section>
