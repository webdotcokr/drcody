...
<main>
    ...
    <section class="bg-gray-50">
        <div class="py-20 container flex flex-col">
            ...
            <p class="SectionTitleText font-bold text-center">시작이 반! 이것만 준비하세요.</p>
            <div class="mt-12 grid grid-cols-3 gap-3 max-md:grid-cols-1">
                ...
                <div class="px-16 py-12 max-md:px-8 max-md:py-10 bg-white border border-gray-300">
                    ...
                    <h5 class="text-lg font-medium text-[var(--main-brown02)]">옷과 물품을 모두 빼주세요.</h5>
                ...
                <div class="px-16 py-12 max-md:px-8 max-md:py-10 bg-white border border-gray-300">
                    ...
                    <h5 class="text-lg font-medium text-[var(--main-brown02)]">십자드라이버(또는 전동드릴), <br/>포장용 테이프 딱 두 가지만 있으면 됩니다.</h5>
                ...
                <div class="px-16 py-12 max-md:px-8 max-md:py-10 bg-white border border-gray-300">
                    ...
                    <h5 class="text-lg font-medium text-[var(--main-brown02)]">작업할 수 있는 최소한의 공간을 만들어주세요.</h5>
                    <div class="mt-10 max-md:mt-7 flex items-center justify-center">
    ...
    <section class="container py-20 flex flex-col items-center">
        ...
        <p class="SectionTitleText font-bold text-center">분해는 조립의 역순? <br/>디알코디는 더 쉽습니다.</p>
        <div class="mt-12 max-md:mt-4 flex max-md:flex-col items-center gap-20 max-md:gap-6">            
            <img src="<?php echo G5_THEME_URL?>/img/transferGuide-1.webp">
            <div class="">
                <h4 class="check H5 font-bold">선반과 옷봉 분리</h4>
                <h5 class="mt-1 text-lg font-medium text-[var(--main-brown02)]">도구 없이 손으로! 선반을 가볍게 들어 올려 홈에서 빼내면 끝.</h5>
    ...
    <section class="py-20 bg-gray-50">
        ...
        <h4 class="SectionTitleText font-bold">전문가처럼 안전하게 포장하기</h4>
            <!-- CONTAINER -->
            <div class="mt-8 grid grid-cols-3 gap-3 max-md:grid-cols-1">
                ...
                <div class="p-10 max-md:p-5 border border-gray-300 rounded-md">
                    <div>
                        ...
                        <h6 class="text-lg font-medium text-[var(--main-brown02)] max-md:mt-1">같은 크기끼리 묶어주세요.</h6>
                    </div>
                    <img class="mt-10 max-md:mt-6" src="<?php echo G5_THEME_URL?>/img/transferGuide-4.webp">
                </div>
                <div class="p-10 max-md:p-5 border border-gray-300 rounded-md">
                    <div>
                    ...
                    <img class="mt-10 max-md:mt-6" src="<?php echo G5_THEME_URL?>/img/transferGuide-5.webp">
                </div>
                <div class="p-10 max-md:p-5 border border-gray-300 rounded-md">
                    <div>
                    ...
                    <img class="mt-10 max-md:mt-6" src="<?php echo G5_THEME_URL?>/img/transferGuide-6.webp">
                </div>
            </div>
        </div>
    </section>
    <section class="py-20 container flex flex-col items-center">
        ...
        <p class="SectionTitleText font-bold">새로운 공간, 완벽한 재탄생</p>
